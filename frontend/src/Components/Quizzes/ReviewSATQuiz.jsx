...
function ReviewSATQuiz() {
    const survey = new Model(quizJsonSAT);
    survey.data = { question1 : "active during the night", question2 : "debunk", question3: 100, question4: true, question5: "defenestration"};
