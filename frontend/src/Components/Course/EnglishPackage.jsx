...
import IELTS_image from "frontend\src\assets"
import SAT_image from "frontend\src\assets"
import Cambridge_C2_Image from "frontend\src\assets"

const EnglishPackage = () => {
  return (
    <EnglishPackageContainer>
        <MainTitle>Purchased Packages</MainTitle>
        <InputContainer> <Input type="text" placeholder="search"/>
        </InputContainer>
        <PackageContainer>
            <Course
                image={IELTS_image}
